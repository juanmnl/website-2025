export default {
  title: 'Retro Text Effect',
  description: 'Create a vintage 80s text effect in Photoshop',
  type: 'graphic',
  dateAdded: '2025-06-28',
  contentType: 'photoshop',
  thumbnail: '/assets/images/tutorials/thumbnails/retro-text.svg',
  difficulty: 'basic',
  ...
  steps: [
    ...
    },
    {
      ...
      description:
        "Duplicate the text layer (Ctrl/Cmd + J). Clear the layer styles on the copy, right-click the text layer and choose 'Blending Options'. Turn the 'Fill Opacity' to 0, and add a bright stroke in cyan.",
