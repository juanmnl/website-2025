    ...
    console.log('Card clicked');
      ...
      liveComponent: () => (
        <div className="project-card">
          <img src="https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=280&h=120&fit=crop" alt="Project Title" className="card-image" />
    ...
    <div className="digital-garden">
      <header className="garden-header">
        <div className="container">
          <h1>UX/UI Digital Garden</h1>
          <p className="subtitle">A curated collection of micro-tutorials, components, patterns, and whatever...</p>
        </div>
      </header>
